...
** Examples
   ...
   =huepaper -p -hue 1.0 -lmin 0.3 -lmax 0.6 -smin 0.8 -smax 1.0=
   ...
   =huepaper -p -hue 0.3 -lmin 0.5 -lmax 0.5 -l 0.5 -P 64x36=
   ...
   =huepaper -p -l -lb -ld -e nixos.png=
